...
public class PostgresGenerator extends SqlGenerator {
	...
	public static final List<String> INTEGER_TYPES = Arrays.asList("BIGINT", "INT", "INT2", "INT4", "INT8", "INTEGER", "SMALLINT");
	
	public static final List<String> FLOAT_TYPES = Arrays.asList("DOUBLE PRECISION", "FLOAT", "REAL");
	...
	public static final List<String> VARCHAR_TYPES = Arrays.asList("VARCHAR", "CHARACTER VARYING");
	
	public static final List<String> CHAR_TYPES = Arrays.asList("CHAR", "CHARACTER");
	...
	public static final List<String> DATE_TIME_TYPES = Arrays.asList("TIMESTAMP", "TIMESTAMP WITH TIME ZONE", "TIMESTAMP WITHOUT TIME ZONE", "TIME", "TIME WITH TIME ZONE", "TIME WITHOUT TIME ZONE");
	...
	public static final List<String> BLOB_TYPES = Arrays.asList("BYTEA", "IO");
	
	public static final List<String> CLOB_TYPES = Arrays.asList("TEXT");
	...
	public static final List<String> ALL_BOOLEAN_TYPES = Arrays.asList("BOOLEAN");
	
	public static final List<String> ALL_TYPES = 
			Stream.concat(ALL_NUMERIC_TYPES.stream(), Stream.concat(ALL_CHARACTER_TYPES.stream(), Stream.concat(ALL_DATE_TYPES.stream(), Stream.concat(ALL_BINARY_TYPES.stream(), ALL_BOOLEAN_TYPES.stream()))))
		    .distinct()
		    .collect(Collectors.toList());
	...
	protected String mapDataType(String type) {
		...
		if (DataTypes.getAllBooleanTypes().contains(upperType)) {
			return ALL_BOOLEAN_TYPES.get(0);
		}
