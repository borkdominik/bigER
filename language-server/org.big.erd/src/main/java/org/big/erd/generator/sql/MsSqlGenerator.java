...
public class MsSqlGenerator extends SqlGenerator {
	...
	public static final List<String> INTEGER_TYPES = Arrays.asList("BIGINT", "INT", "SMALLINT", "TINYINT");
	
	public static final List<String> FLOAT_TYPES = Arrays.asList("FLOAT", "REAL");
	...
	public static final List<String> VARCHAR_TYPES = Arrays.asList("VARCHAR", "NVARCHAR");
	
	public static final List<String> CHAR_TYPES = Arrays.asList("CHAR", "NCHAR");
	...
	public static final List<String> DATE_TIME_TYPES = Arrays.asList("DATETIME2", "DATETIME", "SMALLDATETIME", "DATETIMEOFFSET", "TIME");
	...
	public static final List<String> BLOB_TYPES = Arrays.asList("VARBINARY", "IMAGE");
	
	public static final List<String> CLOB_TYPES = Arrays.asList("TEXT", "NTEXT");
	...
	public static final List<String> ALL_BOOLEAN_TYPES = Arrays.asList("BIT");
