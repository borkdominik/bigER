...
/**
 * Generates SQL for MySQL from the ER model.
 */
public class MySqlGenerator extends SqlGenerator {
	
	public static final List<String> INTEGER_TYPES = Arrays.asList("BIGINT", "INT", "MEDIUMINT", "SMALLINT", "TINYINT");
	
	public static final List<String> FLOAT_TYPES = Arrays.asList("DOUBLE", "FLOAT");
	
	public static final List<String> DECIMAL_TYPES = Arrays.asList("NUMBER", "DECIMAL");
